  ...
  return (
    <div className="bg-[#fcfcfc] min-h-screen pb-20 font-sans text-navy-950">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-8">
        ...
        <h1 className="text-3xl font-normal mb-8 max-w-4xl mx-auto">
          {filtered.length.toLocaleString()} articles
        </h1>

        {/* Sorting Tabs */}
        <div className="max-w-4xl mx-auto border-b border-gray-200 mb-6 flex gap-6 overflow-x-auto hide-scrollbar">
        ...
        {/* Filter Badges */}
        <div className="max-w-4xl mx-auto flex flex-wrap gap-3 mb-10">
